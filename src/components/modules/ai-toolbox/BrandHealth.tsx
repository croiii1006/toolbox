...
import { ArrowLeft, Download, FileImage, FileText, AlertTriangle, TrendingUp, Users, Target, Shield, Zap, ChevronRight, ExternalLink, Database, History } from 'lucide-react';
        ...
        <div className="mt-4 space-y-3">
          {MOCK_HISTORY.map((entry) => (
            <button
              ...
              className="w-full text-left p-3 rounded-xl border border-border/30 hover:border-border/60 hover:bg-muted/20 transition-all"
            >
